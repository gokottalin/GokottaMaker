...
更新时间：2026-05-09 21:45
当前有效版本：V2.4.1+20260509-2145
...
Agent6/Leo 的小程序中心与 GokottaElec 在线预览方向合理，已作为独立访客功能域接入，不混入文章、项目、CMS 数据模型。当前总控已补齐本轮批注：小程序版本标识同步到 V1.3、访客端新增日夜模式切换、页眉 Logo 仅显示图形并放大、Hero 小卡片降低玻璃模糊度、CMS 轮播排序区只保留 0-3 并优化响应式、封面选择改为同风格按钮。当前站点版本提升到 V2.4.1。
