...
更新时间：2026-05-09 18:49
当前有效版本：V2.4.0+20260509-1956
...
Agent6/Leo 的小程序中心与 GokottaElec 在线预览方向合理，已作为独立访客功能域接入，不混入文章、项目、CMS 数据模型。本轮总控补齐了发布前遗漏：SVG 预览改为 Blob 图片渲染，新增小程序页面进入 sitemap，运行时 `.tmp/` 加入忽略列表，并将版本提升到 V2.4.0。
